...
<body>
    ...
    try {
        ...
        $update_query = $db->prepare("UPDATE passengers SET f_name = :f_name, m_name = :m_name, l_name = :l_name, ssn = :ssn WHERE ssn = :old_ssn and :f_name NOT LIKE '%[^a-Z]%' and :ssn LIKE '___-__-____';");
